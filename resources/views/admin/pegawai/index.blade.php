...
<!-- end modal -->
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-header">
                                ...
                                <a href="{{url('admin/pegawai/exportexcel')}}" class="btn btn-primary btn-sm" target="_blank"> Export to Excel</a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="#" method="POST">
                                                    ...
                                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="model" data-bs-target="#exampleModelLabel{{$p->id}}">
                                                        Hapus</button>
                                                    <!-- Modal -->
