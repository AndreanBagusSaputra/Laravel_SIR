...
<form method="POST" action="{{url('admin/pegawai/update')}}" enctype="multipart/form-data">
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      ...
      <div class="costum-control costum-radio costum-control-inline">
        <input name="gender" id="radio_0" type="radio" class="form-check-input" value="{{gender}}" {{$cek}}> 
        <label for="radio_0" class="form-check-label">{{$gender}}i</label>
      </div>
  ...
  <div class="form-group row">
    ...
    <div class="col-8">
      <input id="text2" name="kekayaan" type="text" class="form-control" placeholder="Masukan Kekayaan Anda">
    </div>
  </div>
  <div class="form-group row">
